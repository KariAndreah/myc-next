    ...
    <div className="flex flex-col items-center justify-center py-36 bg-black-white bg-cover shadow-box-shadow-background min-h-[100vh]">
      <Card className="flex flex-1 bg-slate-500 pt-32 max-w-[800px]">
        ...
        <p className="pt-2">
          ...
          whether theya re free.
        </p>
        <h3 className="font-bold text-xl pt-6">How can I support the app?</h3>
        <p className="pt-2">
          {' '}
          If you are enjoying the app my Venmo, Cashapp, are below. Especially if you actually make
          it{' '}
        </p>
        ...
        <p className="pt-2">
          OpenMYC was created by Kari Burt, a comedian from Houston that was trying to navigate the
          NYC open mic scene.
        </p>
